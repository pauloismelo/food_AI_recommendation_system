...
export class UserView extends View {
    ...
    #userRegion = document.querySelector('#userRegion');
    ...
    renderUserDetails(user) {
        ...
        this.#userRegion.value = user.region ? user.region.replace(/_/g, ' ') : '';
    }
    ...
    renderPastPurchases(pastPurchases) {
        ...
        if (!pastPurchases || pastPurchases.length === 0) {
            this.#pastPurchasesList.innerHTML = '<p>Previous orders not found.</p>';
            return;
        }
    ...
    addPastPurchase(product) {
        ...
        if (this.#pastPurchasesList.innerHTML.includes('Previous orders not found')) {
